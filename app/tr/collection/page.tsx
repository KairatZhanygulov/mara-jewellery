...
const collections = [
  {
    title: "Işığın Mimarı",
    text: "Mimarinin zarafetle buluştuğu yer. Yapıda ve netlikte güzellik bulanlar için tasarlanmış cesur geometrik formlar.",
    image: "/collection1.jpg",
    color: "bg-[#a88745]",
  },
  {
    title: "Dünyanın Yankısı",
    text: "Modern ruh için kadim enerji. Dünyanın vahşi unsurlarından ilham alan organik dokular ve derin değerli taşlar.",
  ...
  {
    title: "Derin Kor",
    text: "Her parıltıda bir miras. Sofistike güç ve derin gizemli bir görünüm için tasarlanmış yoğun ateş tonları ve zamansız altın.",
...
const categories = [
  ...
  { name: "Bilezikler", image: "/bracelets.jpg" },
  ...
  return (
    <main className="bg-[#f5f5f5] text-black">
      ...
      <section className="max-w-6xl mx-auto px-10 py-20 text-center">
        <h2 className="text-3xl font-serif mb-3">Kategoriler</h2>
        <p className="text-gray-500 mb-14">
          İlgili parçaları incelemek için bir kategoriye tıklayabilirsiniz.
        </p>
